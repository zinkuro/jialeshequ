...
@property (nonatomic,strong) JMStatusTableViewController *statustTableView;
@end

@implementation JMClubDetailViewController

- (JMStatusTableViewController *)statustTableView {
    if (!_statustTableView) {
        _statustTableView = [[JMStatusTableViewController alloc]init];
        _statustTableView.requestURL = self.requestURL;
        _statustTableView.requestDict = self.requestDict;
    }
    return _statustTableView;
}
...
//    self.statustTableView.tableView.tableHeaderView = self.headerView;
    [self.view addSubview:self.headerView];
    UIView *tableBackgroundView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT * 3 / 8.0f, SCREEN_WIDTH, SCREEN_HEIGHT * 5 / 8.0f)];
    [self.view addSubview:tableBackgroundView];
    [tableBackgroundView addSubview:self.statustTableView.view];
